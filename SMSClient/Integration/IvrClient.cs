...
namespace SMSClient.Integration
{
    public class IvrClient //interface with Vivify API
    {
        ...
        public IvrClient(string url = Constants.BaseUrl)
        {
        ...
        {
            var request = new RestRequest(Constants.UrlCreateSession, Method.POST);
            request.AddUrlSegment("id", Constants.ClientId);
            request.AddParameter("ApplicationKey", Constants.ApiKey);
            request.AddParameter("SecretKey", Constants.ApiSecret);
        ...
        {
            var request = new RestRequest(Constants.UrlGetPatient, Method.GET);
        ...
        {
            var request = new RestRequest(Constants.UrlGetAllPatients, Method.GET);
        ...
        {
            var request = new RestRequest(Constants.UrlGetPatientSurveys, Method.GET);
        ...
        {
            var request = new RestRequest(Constants.UrlGetPatientSurveyQuestion, Method.GET);
        ...
        {
            var request = new RestRequest(Constants.UrlPostPatientResponse, Method.POST) { RequestFormat = DataFormat.Json };
