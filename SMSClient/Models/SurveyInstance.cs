...
namespace SMSClient.Models
{
    public class SurveyInstance
    {
        ...
        public SurveyInstance(int userID, string phone)
        {
            ...
            var twilio = new TwilioRestClient(Constants.AccountSid, Constants.AuthToken);
            var send = twilio.SendMessage(Constants.twilioNumber, phone, "Are you ready to take your survey?");
        }
        ...
        public void fetchSurvey()//gets survey AND sets first currentQuestion value
        {
            ...
            request.AddParameter("authtoken", Constants.requestObjectVal, ParameterType.QueryString);
